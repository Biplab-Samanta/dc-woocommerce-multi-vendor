...
Class MVX_Admin_Dashboard {
    ...
    public function save_store_settings($user_id, $post) {
        ...
        if (isset($_POST['vendor_banner_type']) && !empty($_POST['vendor_banner_type'])) {
            mvx_update_user_meta($user_id, 'vendor_banner_type', wc_clean($_POST['vendor_banner_type']));
        }

        //video link
        if (isset($_POST['vendor_video_link']) && !empty($_POST['vendor_video_link'])) {
            mvx_update_user_meta($user_id, 'vendor_video_link', wc_clean($_POST['vendor_video_link']));
        }
        ...
        mvx_update_user_meta($user_id, '_slider_image_gallery', implode( ',', $attachment_ids ) );
