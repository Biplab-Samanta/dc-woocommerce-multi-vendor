...
$vendor_banner_type = get_user_meta($vendor->id, 'vendor_banner_type');
$vendor_video = get_user_meta($vendor->id, 'vendor_video_link', true);
?>
<style>
    .store-map-address{
        margin-top: 10px;
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-md-6 col-sm-9">
                            <ul class="slider_images">
                                ...
                                if ( metadata_exists( 'user', $vendor->id, '_slider_image_gallery' ) ) {
                                    $slider_image_gallery = get_user_meta( $vendor->id, '_slider_image_gallery', true );
                                } else {
