...
$vendor_banner_type = get_user_meta($vendor_id, 'vendor_banner_type', true);
$vendor_video = get_user_meta($vendor_id, 'vendor_video_link', true);

$slider_image_gallery = get_user_meta( $vendor_id, '_slider_image_gallery', true );

if ( $template_class == 'template3') { ?>
<div class='mvx_bannersec_start mvx-theme01'>
    <div class="mvx-banner-wrap">
        <?php $MVX->template->get_template('mvx-archive-page-banner.php', array('banner' => $banner , 'vendor_banner_type' => $vendor_banner_type, 'vendor_video' => $vendor_video, 'slider_image_gallery' => $slider_image_gallery)); ?>
        <div class='mvx-banner-area'>
            <div class='mvx-bannerright'>
                <div class="socialicn-area">
                    <div class="mvx_social_profile">
                    <?php if ($vendor_fb_profile) { ?> <a target="_blank" href="<?php echo esc_url($vendor_fb_profile); ?>"><i class="mvx-font ico-location-icon"></i></a><?php } ?>
                    ...
                    <?php if ($vendor_pinterest_profile) { ?> <a target="_blank" href="<?php echo esc_url($vendor_pinterest_profile); ?>"><i class="mvx-font ico-call-icon"></i></a><?php } ?>
